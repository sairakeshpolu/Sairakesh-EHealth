	...
	<body class="login">
		<div class="row">
			<div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
				...
				<a href="../../index.html"><h2> EHCMS | Doctor Password Recovery</h2></a>
				</div>
				...
				<div class="box-login">
					...
					<div class="copyright">
						&copy; <span class="current-year"></span><span class="text-bold text-uppercase"> EHCMS</span>. <span>All rights reserved</span>
					</div>
